...
caffeModelFile = "./dnn/res10_300x300_ssd_iter_140000.caffemodel"
caffeProtoTxt = "./dnn/deploy.prototxt.txt"
...
image = cv2.imread("./testimages/test3.jpg")

(h, w) = image.shape[:2] #get image height and width

#step4: convert image to blod
